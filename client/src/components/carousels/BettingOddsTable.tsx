export function BettingOddsTable() {
  const boxStyling =
    'flex my-1 justify-center items-center rounded-md bg-zinc-700 h-1/3 text-red-600';

  return (
    <div className="flex justify-center mt-6 2xl: w-2/3">
      <div className="flex py-2 rounded-md bg-zinc-800 w-[90%] h-36 mt-2">
